  ...
  return (
    <Dialog open={isOpen} onClose={onClose} className="relative z-50">
      ...
      <div className=" fixed inset-0 z-10 overflow-y-auto p-10 py-20 md:py-32">
        <Dialog.Panel className="relative w-full md:w-2/3 mx-auto relative overflow-hidden rounded-xl bg-white px-6 py-10 shadow-2xl  transition-all dark:bg-gray-900">
